...
Gem::Specification.new do |s|
  ...
  s.authors = ["bmilekic", "minaguib", "gdi"]
  s.date = %q{2009-12-16}
  s.default_executable = %q{rackup}
  s.description = %q{See http://groups.google.com/group/rack-devel/browse_thread/thread/ce7315f79cf0cdfc for details}
  s.email = %q{bosko@bloomdigital.com}
  ...
  s.homepage = %q{http://github.com/bloom/rack}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.5}
  s.summary = %q{A forked rack/rack with fix to multipart parser}
  s.test_files = [
    "test/spec_rack_auth_basic.rb",
     "test/spec_rack_auth_digest.rb",
     "test/spec_rack_auth_openid.rb",
